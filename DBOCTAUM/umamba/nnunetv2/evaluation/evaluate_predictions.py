...
if __name__ == '__main__':
    ...
    folder_pred = '/root/autodl-tmp/U-Mamba-main/data/nnUNet_predict_result/Dataset110_ea__result'
    output_file = '/root/autodl-tmp/U-Mamba-main/data/eval_result/110_ea.json'
