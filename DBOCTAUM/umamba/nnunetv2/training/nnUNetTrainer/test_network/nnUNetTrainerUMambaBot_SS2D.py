...
# from nnunetv2.nets.UMambaBotSS2D_2d import get_umamba_bot_2d_from_plans
from nnunetv2.training.loss.dice import get_tp_fp_fn_tn

class nnUNetTrainerUMambaBot_SS2D(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print("UMambaBot_SS2D: {}".format(model))
