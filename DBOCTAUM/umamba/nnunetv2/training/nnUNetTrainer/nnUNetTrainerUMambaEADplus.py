...
from nnunetv2.nets.UMambaEbestELA_2d import get_umamba_enc_2d_from_plans
from nnunetv2.training.loss.dice import get_tp_fp_fn_tn


# OCTAUM-EAT,umamba里加ela,LOSS加dice++损失
class nnUNetTrainerUMambaEADplus(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print("UMambaEAttnELA: {}".format(model))
