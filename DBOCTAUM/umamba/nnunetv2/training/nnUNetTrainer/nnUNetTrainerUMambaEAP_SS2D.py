...
from nnunetv2.nets.UMambaEncSS2D_2d import get_umamba_enc_2d_from_plans
from nnunetv2.training.loss.dice import get_tp_fp_fn_tn

class nnUNetTrainerUMambaEAP_SS2D(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print("UMambaEAP_SS2D: {}".format(model))
